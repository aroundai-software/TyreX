...
final vehicleService = VehicleService();
  ...
  Future<void> _createVehicle() async {
    ...
    if (_newClientNameController.text.isEmpty ||
        _newClientPhoneController.text.isEmpty ||
        _newOdometerController.text.isEmpty ||
        _selectedBrand == null ||
        _selectedModelId == null) {
      _showErrorSnackBar('Please fill all mandatory (*) fields.');
      return;
    }
      ...
      child: Column(
        ...
        children: [
          const Row(children: [
            ...
            SizedBox(width: 8),
            Text('Register New Vehicle', style: TextStyle(fontSize: 20,
                fontWeight: FontWeight.bold,
                color: Colors.orange)),
          ]),
          const Padding(
              padding: EdgeInsets.symmetric(vertical: 8.0),
              child: Text("Vehicle not found. Please add the details below.",
                  style: TextStyle(color: AppTheme.textSecondary))),
          const Divider(height: 24),
          const FormLabel(text: 'Vehicle Number'),
          TextField(
              controller: TextEditingController(
                  text: _vehicleNumberController.text),
              readOnly: true,
            ...
            builder: (context, adminSettings, child) {
              ...
              return Column(
                ...
                children: [
                  ...
                  TextField(controller: _newVehicleNameController,
          ...
          TextField(controller: _newClientNameController,
          ...
          TextField(
              controller: _newClientPhoneController,
              decoration: const InputDecoration(
                  hintText: 'e.g., 9876543210', counterText: ""),
              keyboardType: TextInputType.phone,
              inputFormatters: [FilteringTextInputFormatter.digitsOnly],
              maxLength: 10),
          const SizedBox(height: 16),
  ...
  Widget _buildNewComplaintCard() {
    return AppCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Register New Complaint(s)',
          ...
          Row(children: [
            Expanded(
                child: TextField(
                    ...
                    decoration: const InputDecoration(
                        hintText: 'e.g., Puncture repair, Wheel alignment',
