...
class OcrService {
  static Future<String?> recognizeVehicleNumber(String imagePath) async {
  ...
  static String? _extractVehicleNumber(String text) {
    ...
    final patterns = [
      ...
      RegExp(r'[A-Z]{2}\d{1,2}[A-Z]{1,2}\d{4}'), // Standard: KL07AB1234
      RegExp(r'[A-Z]{2}\d{2}[A-Z]{1,2}\d{3}'), // e.g., TN37C987
      RegExp(r'[A-Z]{2}\d{2}[A-Z]{1,2}\d{1,4}'), // Generic catch-all
    ];
